  ...
  return (
    <div className="demographics">
      <form name="demo">
        ...
        <h3 className="leftQuestion">
          What is your household pre-tax income? (Enter a number, rounded to the
          nearest 1000, with no periods or commas; For example, 55000)
        </h3>
        ...
        <h3 className="leftQuestion">
          ...
          society. At the top of the ladder are the people who are the best off,
          those who have the most money, most education, and best jobs. At the
          bottom are the people who are the worst off, those who have the last
          money, least education, worst jobs, or no job. Please select the rung
          that best represents where you think you stand on the ladder.
        </h3>
        <div className="vacationContainer">
          <div className="box">
            <input
            ...
            <div>
              <img
                src="../../public/Photos/Ladder/ladder1.jpg"
                width="60px"
                alt="1"
              />
            </div>
            ...
            <div>
              <img
                src="../../public/Photos/Ladder/ladder2.jpg"
                width="60px"
                alt="2"
              />
            </div>
            ...
            <div>
              <img
                src="../../public/Photos/Ladder/ladder3.jpg"
                width="60px"
                alt="3"
              />
            </div>
            ...
            <div>
              <img
                src="../../public/Photos/Ladder/ladder4.jpg"
                width="60px"
                alt="4"
              />
            </div>
            ...
            <div>
              <img
                src="../../public/Photos/Ladder/ladder5.jpg"
                width="60px"
                alt="5"
              />
            </div>
            ...
            <div>
              <img
                src="../../public/Photos/Ladder/ladder6.jpg"
                width="60px"
                alt="6"
              />
            </div>
            ...
            <div>
              <img
                src="../../public/Photos/Ladder/ladder7.jpg"
                width="60px"
                alt="7"
              />
            </div>
            ...
            <div>
              <img
                src="../../public/Photos/Ladder/ladder8.jpg"
                width="60px"
                alt="8"
              />
            </div>
            ...
            <div>
              <img
                src="../../public/Photos/Ladder/ladder9.jpg"
                width="60px"
                alt="9"
              />
            </div>
            ...
            <div>
              <img
                src="../../public/Photos/Ladder/ladder10.jpg"
                width="60px"
                alt="10"
              />
            </div>
        ...
        <h3 className="leftQuestion">
          How often do you use the Internet to look up information about people,
          things, or ideas?
        </h3>
        <div className="vacationContainer">
          <div className="vacationBox">
