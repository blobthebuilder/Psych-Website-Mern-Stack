...
function End() {
  return (
    <div className="end">
      ...
      <p className="instructions">
        We are interested in understanding whether people who use AI-based tools
        that are described as being tailored specifically to them are more
        likely to accept the recommendations made by the software. We also want
        to examine whether environmental values can change as a result of the AI
        recommendations.
      </p>
      <p className="instructions">
        To try to obtain unbiased or natural reactions, we informed you that one
        version of the Smart Traveler tool was programmed based on your
      ...
      <p className="instructions">
        Because this study is ongoing, we request that you do not share the true
        nature and purpose of this experiment with others who might potentially
      ...
      <p className="instructions">
        ...
        lindsaymiller@ucsb.edu. If you have any questions regarding your rights
        as a participant in this research project, please contact the Human
        Subjects Committee at (805) 893-3807 or hsc@research.ucsb.edu. Or write
        to the University of California, Human Subjects Committee, Office of
